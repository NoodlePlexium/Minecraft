...
public:
	...
	Renderer(GameWindow &_window, EngineDevice &device) : window{_window}, engineDevice{device}
	{
		recreateSwapChain();
	...
	int getFrameIndex() const {
		assert(isFrameStarted && "Can't get frame index when fram not in progress!");
